...
class Channels {     
    ...
    public function index(){
        ...
        $starred = DB::channels()->where('userid', user()->rID())->where('starred', 1)->orderByAsc('name')->findMany();

        $channels = DB::channels()->where('userid', user()->rID())->orderByAsc('name')->paginate(12);
