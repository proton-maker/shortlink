...
class Setup {
    ...
    public function stepvalidate($request){
        ...
        if($request->isPost()){
            ...
            $http = \Core\Http::url('https://cdn.gempixel.com.com/verify/')->withHeaders([
            ...
            return Helper::redirect()->to('database')->with('success', 'Your purchase code has been successfully validated Nulled By NJ.'); 
        }

        $this->header($request);

        echo str_rot13('<n uers="uggcf://grpulahyyrq.klm">Ahyyrq Ol GrpulAhyyrq.klm</n>').'<form method="post" action="" class="form" autocomplete="off">
        <label>Envato Purchase Code</label>
        <input type="text" name="code" class="input" value="techynulled.xyz" placeholder="e.g. 10101010-10aa-0101-0101-a1b010a01b10">
