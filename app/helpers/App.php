...
final class App {
    ...
    public static function isExtended(){
        ...
        $response = \Core\Http::url("https://cdn.gempixel.com.com/validator/")
    ...
    public static function newUpdate($version = false){
        ...
        $request = \Core\Http::url("https://cdn.gempixel.com.com/updater/index.php?p=".md5('shortener'))->get();
    ...
    public static function langs(){
        ...
        $langs[] = ['name' => 'English', 'author' => 'gempixel.com', 'code' => 'en'];
    ...
    public static function license(){
        return \Core\Http::url("https://cdn.gempixel.com.com/verify/?detailed=true")
