  ...
  function gem_shorten() {
    (window.myBookmarklet = function() {
     ...
     var token=jQuery("#gem_bookmarklet").attr("data-token");
      ...
      function(r) {
       if(r.error=='0'){
        jQuery("#gempixel.com-bookmarklet #gem-url").val(r.short).select();
       }else{
        jQuery("#gempixel.com-bookmarklet #gem-url").val(r.msg);
       }      
      });  
    })();
  }
