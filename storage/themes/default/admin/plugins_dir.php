...
<div class="row">
    <div class="col-md-6">
      <form action="<?php echo route('admin.plugins.dir') ?>" method="get" class="card card-body">
        ...
        <h6 class="my-3"><?php ee('Filter by Category') ?></h6>
        <p>
        <?php foreach($categories as $category): ?>
            <a href="<?php echo route('admin.plugins.dir', ['category' => $category]) ?>" class="btn btn-outline-dark rounded btn-sm"><?php echo ucfirst($category) ?></a>
        <?php endforeach ?>
        </p>
      </form>
    </div>
