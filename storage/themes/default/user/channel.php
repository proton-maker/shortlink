<div class="d-flex mb-5">
    <div>
        <h1 class="h3 mb-2"><?php echo $channel->starred ? '<i data-feather="star"></i>' : '' ?> <?php echo $channel->name ?></h1>
        <p><?php echo $channel->description ?></p>
    </div>
    <div class="ms-auto">
        <a class="btn btn-light shadow" href="<?php echo route('channel.update', [$channel->id]) ?>" data-bs-toggle="modal" data-bs-target="#updateModal" data-toggle="updateFormContent" data-content='<?php echo json_encode(['newname' => $channel->name, 'newdescription' => $channel->description, 'newcolor' => $channel->color, 'newstarred' => $channel->starred]) ?>'><?php ee('Edit') ?></span></a>
    </div>
</div>
<div class="row">
