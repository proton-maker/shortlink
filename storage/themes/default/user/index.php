    ...
    <div class="col-md-6">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center">                
                <h3 class="card-title mb-0 d-none d-sm-block"><?php ee('Recent Links') ?></h3>
                <div class="ms-auto">
                    <form class="rounded border" id="search" action="<?php echo route('search') ?>">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="mb-2">
                                ...
                                <?php else: ?>
                                    ...
                                    <a href="<?php echo $stats->url->url ?>" target="_blank" rel="nofollow"><strong class="text-break"><?php echo \Core\Helper::truncate(\Core\Helper::empty($stats->url->meta_title, $stats->url->url), 30) ?></strong></a> <small class="text-muted" data-href="<?php echo Helpers\App::shortRoute($stats->url->domain, $stats->url->alias.$stats->url->custom) ?>"><?php echo Helpers\App::shortRoute($stats->url->domain, $stats->url->alias.$stats->url->custom) ?></small>
                                <?php endif ?>
                            </div>
